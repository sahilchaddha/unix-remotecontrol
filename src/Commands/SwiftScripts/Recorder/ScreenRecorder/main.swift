...
httpStream.attachScreen(AVCaptureScreenInput(displayID: CGMainDisplayID()))

print("http://localhost:8080/screenRecord/playlist.m3u8")
...
class Service {
    ...
    func startService() {
        httpStream.publish("screenRecord")
